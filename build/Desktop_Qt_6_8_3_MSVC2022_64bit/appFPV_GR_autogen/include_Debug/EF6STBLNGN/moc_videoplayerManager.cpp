/****************************************************************************
** Meta object code from reading C++ file 'videoplayerManager.h'
**
...
#error "The header file 'videoplayerManager.h' doesn't include <QObject>."
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->videoSinkChanged(); break;
        case 2: _t->playingChanged(); break;
        case 3: _t->errorStringChanged(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (VideoPlayer::*)();
            if (_q_method_type _q_method = &VideoPlayer::urlChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (VideoPlayer::*)();
            if (_q_method_type _q_method = &VideoPlayer::videoSinkChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (VideoPlayer::*)();
            if (_q_method_type _q_method = &VideoPlayer::playingChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (VideoPlayer::*)();
            if (_q_method_type _q_method = &VideoPlayer::errorStringChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< QVideoSink**>(_v) = _t->videoSink(); break;
    ...
    if (_c == QMetaObject::WriteProperty) {
        ...
        case 1: _t->setVideoSink(*reinterpret_cast< QVideoSink**>(_v)); break;
        default: break;
        }
    }
}
...
// SIGNAL 2
void VideoPlayer::playingChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void VideoPlayer::errorStringChanged()
{
